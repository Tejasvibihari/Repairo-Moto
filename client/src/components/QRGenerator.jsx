        ...
        <>
            ...
            <div className="flex flex-col items-center mt-6 p-4 border shadow-sm rounded">
                ...
                <button
                    ...
                    className={`mt-4 cursor-pointer text-white font-semibold px-6 py-2 rounded-lg transition ${text ? "bg-green-600 hover:bg-green-700" : "bg-gray-400 cursor-not-allowed"}`}
                >
                    Download QR Code
                </button>
            </div>
